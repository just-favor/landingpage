        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_400px_400px] gap-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4 md:px-10 py-8 md:py-12">
              <div className="max-w-2xl w-full bg-stone-200 backdrop-blur-sm rounded-2xl p-4 md:p-6" style={{ height: '420px' }}>
                <div className="flex flex-col gap-4 overflow-hidden h-full justify-center">
                  ...
                  >
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gradient-to-br from-slate-400 to-slate-600 flex-shrink-0 mt-1" />
                    <div className="bg-white rounded-2xl rounded-tl-sm px-3 py-2 md:px-4 md:py-3 shadow-sm max-w-[85%] md:max-w-[50%]">
                      <p className="text-sm md:text-lg font-semibold text-gray-900 mb-0.5">Tether AI</p>
                      <p className="text-sm md:text-lg text-gray-600">How can I help you today?</p>
                    </div>
                  </div>
                  {/* User message */}
                  <div
                  ...
                  >
                    <div className="bg-[#EEFF00] rounded-2xl rounded-br-sm px-3 py-2 md:px-4 md:py-3 max-w-[85%] md:max-w-[50%]">
                      <p className="text-sm md:text-lg font-bold text-gray-900 mb-0.5">Jacob Smith</p>
                      <p className="text-sm md:text-lg text-gray-800 leading-snug">
                        What's a fun activity that I can set up for the team meeting tomorrow?
                      </p>
                    </div>
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex-shrink-0" />
                  </div>
                  {/* AI message 2 */}
                  <div
                    className="flex items-start gap-3 transition-all duration-700 ease-out"
                  ...
                  >
                    ...
                    <div className="bg-white rounded-2xl rounded-tl-sm px-3 py-2 md:px-4 md:py-3 shadow-sm max-w-[85%] md:max-w-[50%]">
                      <p className="text-sm md:text-lg font-semibold text-gray-900 mb-0.5">Tether AI</p>
                      <p className="text-sm md:text-lg text-gray-600">Let me generate a few ideas…</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-white rounded-3xl p-6 md:p-10 flex-1 flex flex-col items-start justify-between min-h-[200px] md:min-h-0">
              ...
              <p className="text-base md:text-lg text-black leading-relaxed">Over 8,000 clients trust Tether to connect their teams</p>
            </div>

            <div className="bg-white rounded-3xl p-6 md:p-10 flex-1 flex flex-col items-start justify-between min-h-[200px] md:min-h-0">
              <p className="text-5xl md:text-6xl font-bold text-black mb-4 md:mb-6">+4<span className="text-2xl md:text-3xl font-medium">x</span></p>
              <p className="text-base md:text-lg text-black leading-relaxed">Average increase in team productivity following our operational audits</p>
            </div>
          </div>

          {/* Right column */}
          <div className="flex flex-col gap-4">
            <div className="bg-white rounded-3xl p-6 md:p-10 h-auto md:h-70 flex flex-col items-start justify-between gap-4 md:gap-0 min-h-[200px]">
              <p className="text-5xl md:text-6xl font-bold text-gray-900 tracking-tighter">92<span className="text-xl md:text-2xl font-medium">%</span></p>
              <p className="text-base md:text-lg leading-relaxed">Of clients report measurable ROI within 90 days of using Tether</p>
            </div>

            <div className="relative rounded-3xl overflow-hidden flex-1 min-h-[340px] bg-gradient-to-b from-[#ffe600] via-[#fff9ac] to-[#ffffff]">
              <div className="absolute inset-0 flex items-center justify-center">
                <img src="/IMG_5480-removebg-preview.png" alt="" className="max-h-[300px] object-contain" />
              </div>
